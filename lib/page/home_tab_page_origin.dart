...
class HomeTabPageOrigin extends StatefulWidget {
  final String categoryName;
  final List<BannerMo>? bannerList;
  const HomeTabPageOrigin(
    this.categoryName, {
    super.key,
    this.bannerList,
  });
  ...
  @override
  State<HomeTabPageOrigin> createState() => _HomeTabPageOriginState();
}

class _HomeTabPageOriginState extends State<HomeTabPageOrigin>
